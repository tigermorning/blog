...
window.BIGMAP = {
 ...
 "world": {
  ...
  "steps": [
   ...
   [
    "② 오케스트레이션",
    "질문이 환불·배송 같은 라우트 중 어디로 보낼지 분류하고(라우팅) 처리 순서를 정해요. 사진·음성이 붙어 있으면 멀티모달 단계를 먼저 거치게 해요."
   ],
   [
    "(있을 때만) 멀티모달",
   ...
   [
    "③ 프롬프트·컨텍스트 엔지니어링",
    "지시문, 매뉴얼에서 찾아 온 관련 조각(RAG), 쓸 수 있는 도구 목록, 사진에서 뽑은 글자나 이미지를 모델이 한 번에 읽을 입력 하나로 조립해요."
   ],
   [
    "④ 머신러닝·LLM",
